...
import { showRightSidebarAction, toggleLeftmenu } from '../../../../redux/actions';
...
const stateProps = ({ ui }) => ({
    ...
    showRightSidebar: ui.showRightSidebar,
...
export default connect(stateProps, dispatchProps)(withTranslation()(HeaderNav));
